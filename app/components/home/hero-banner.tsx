  ...
  return (
    ...
    >
      <img
        ...
        width={1920}
        height={1080} // <-- USE YOUR REAL IMAGE HEIGHT
        fetchPriority="high"
        decoding="async"
        style={{
          position: "absolute",
        ...
        <Container size="xl" style={{ maxWidth: 1400, padding: 0 }}>
          ...
          >
            ...
            <Image
              src="/logo.png"
              alt="Fynocrat"
              width={190} // your desktop width
              height={60} // <-- set correct natural height of logo
              style={{
            ...
            <Text
              style={{
                ...
                minHeight: isMobile ? 16 : 30, // <-- prevents CLS when font loads
              }}
            >
